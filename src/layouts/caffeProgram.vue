<template>
    <app-program :program=program>
        <template v-slot:header>
            <div class="card-container flex-row reverse">
                ...
                <div class="flex-column info">
                    ...
                    <button v-on:click="openForm" style="background-color: #000092" class="more">Оформить
                        договор
                    </button>

                </div>
                <div class="flex-column" style="justify-content: flex-end">
                    <div class="header__circle header__flex-column" style="background-color: #000092"><span
        ...
        <template v-slot:summary>
            <span><strong>6 млн</strong> рублей по имущественным рискам.</span>
            <span><strong>1,5 млн</strong> рублей по ответственности перед третьими лицами.</span>
        </template>
        <template v-slot:price>
            <span><strong>35 420,00  </strong> рублей в год.</span>
        </template>
        <template v-slot:save>
            <li>
                <span>Имущество (расходы на ремонт и отделку, мебель, профессиональное оборудование, витрины, посуда).</span>
            </li>
